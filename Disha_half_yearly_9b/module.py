...
def rectangle():
    ...
    import numpy as np
    blank=np.zeros((500,500,3),dtype='uint8')
    cv.rectangle(blank,(0,0),(blank.shape[1]//2,blank.shape[0]//2),(255,255,0),thickness=3)
...
def line():
    ...
    import numpy as np
    blank=np.zeros((500,500,3),dtype='uint8')
    cv.line(blank,(0,0),(300,400),(255,0,255),thickness=3)
...
def text():
    ...
    import numpy as np
    blank=np.zeros((500,500,3),dtype='uint8')
    cv.putText(blank,'Disha Navya',(0,255),cv.FONT_HERSHEY_TRIPLEX,1.0,(0,0,255),thickness=3)
...
def translate():
    import cv2 as cv
    import numpy as np
    img=cv.imread('Resources/Photos/park.jpg',0)
    rows,cols=img.shape
...
def shrink():
    ...
    img = cv.imread('Resources/Photos/cats.jpg', 0)
    rows, cols = img.shape
    img_shrinked=cv.resize(img, (250, 200),interpolation=cv.INTER_CUBIC)
...
def enlarge():
    ...
    img = cv.imread('Resources/Photos/cats.jpg', 0)
    rows, cols = img.shape
    img_enlarged = cv.resize(img, (700,800),interpolation=cv.INTER_CUBIC)
